...
package object next {
  implicit final class NextSCSetCompanionExtensions(@unused private val self: Set.type)
      extends AnyVal {
  ...
  implicit final class NextSCSortedSetCompanionExtensions(@unused private val self: SortedSet.type)
      extends AnyVal {
