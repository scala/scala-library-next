...
package object next {
  implicit final class NextSCISetCompanionExtensions(@unused private val self: Set.type)
      extends AnyVal {
  ...
  implicit final class NextSCISortedSetCompanionExtensions(@unused private val self: SortedSet.type)
      extends AnyVal {
